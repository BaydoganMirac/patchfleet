...
Task card 0008 proposes connecting the proven Gemini decoder through Gemini
...
- Owner review of the proposed setup, sanitized inbox, and manual-refresh
  ingestion design.

## Next up

1. Accept or revise ADR 0012 and Task card 0008.
2. After explicit approval, assign one Builder.
3. Start the independent Reviewer only after the Builder commit exists.
4. Let the owner perform the first real extension link/uninstall smoke after
   reviewed code exists.

## Blockers

- Explicit owner design approval is required before implementation.

## Open questions

- None in the proposed V0 scope. Packaged extension installation replaces the
